...
export const ExperienceItem = ({ logo, institution, course, date, description, link, technologies }: ExperienceItemProps) => {
            ...
            <div>
                <div className="flex flex-col gap-2 text-sm sm:text-base">
                    <a
                        href={link}
                        target="_blank"
                        className=" text-gray-600 dark:text-gray-500 hover:text-purple-500 transition-colors"
                    >
                        @{institution}
                    </a>
