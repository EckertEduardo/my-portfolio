        ...
        <div className="w-full bg-white dark:bg-black lg:pt-20 pb-12">
            ...
            <div className="container md:py-4 flex justify-center gap-4">
                <button
                    ...
                    className={`cursor-pointer flex text-xl gap-x-2 bg-white dark:bg-black py-2 px-4 ${activeTab === "education" ? "text-purple-700 dark:text-purple-400" : "text-black dark:text-white"} rounded-md`}
                >
                ...
                <button
                    ...
                    className={`cursor-pointer flex text-xl gap-x-2 bg-white dark:bg-black py-2 px-4 ${activeTab === "experience" ? "text-purple-700 dark:text-purple-400" : "text-black dark:text-white"} rounded-md p-3`}
                >
