                        ...
                        <div className="flex items-center justify-between h-20">
                            ...
                            <div className='hidden md:block'>
                                <div className='ml-4 flex items-center space-x-4'>
                                    <UnderlineLink href="#skills-section">{t("a4")}</UnderlineLink>
                                    <UnderlineLink href="#education-section">{t("a2")}</UnderlineLink>
                                    <UnderlineLink href="#projects-section">{t("a3")}</UnderlineLink>
                                    <UnderlineLink href="#contact-section">{t("a5")}</UnderlineLink>
                                </div>
                            </div>
                            <div className='md:hidden flex items-center'>
                                <button className='cursor-pointer inline-flex items-center justify-center p-2 rounded-md text-black dark:text-white hover:text-black dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white' onClick={toggleNavbar}>
                                    {isClick ? (
